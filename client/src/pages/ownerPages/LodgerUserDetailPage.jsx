...
const LodgerUserDetailPage = () => {
  ...
  useEffect(() => {
    dispatch(getLodgerUserDetails({ slug }));
  }, [dispatch, slug]);
  ...
  return (
    <>
      <main className="flex flex-col mx-auto mb-12 mt-10 md:flex md:ml-10">
        <h3 className="font-heading font-semibold text-4xl">Hồ sơ</h3>
        <div className="flex flex-col mt-6 gap-4 md:flex-row">
          ...
          <div className="md:ml-4">
            ...
            <div className="flex mt-2 gap-2 items-center">
              ...
              <a href={`tel:+84${user?.phoneNumber}`} className="ml-3 text-blue-600">
                +84 {user?.phoneNumber}
              </a>
            </div>
            <div className="flex mt-2 gap-2 items-center">
            ...
            <div className="flex mt-2 gap-2 items-center">
              {/* Link to search phone number on Zalo */}
              <a
                href={`https://zalo.me/${user?.phoneNumber}`}
                target="_blank"
...
export default LodgerUserDetailPage;
