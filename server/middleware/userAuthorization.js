...
// Authenticate Lodger User using JWT Token and add userId to req.user object for further use
const authorizeLodgerUser = async (req, res, next) => {
...
export { authorizeOwnerUser, authorizeLodgerUser };
